...
toute restauration. Les copies cloud vivent dans `plans/main/snapshots`. Le déploiement GitHub Pages
est volontairement manuel et rejoue toute la suite de tests avant publication ; voir
