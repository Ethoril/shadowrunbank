...
| 2026-07-19 | Confort d'édition | La liaison « Nœud Réseau » d'un dispositif propose désormais tous les nœuds de l'immeuble (groupés par étage dans la liste déroulante), plus seulement ceux de l'étage courant, pour permettre un réseau partagé entre étages. Tests 33/33 et 18/18 verts | À renseigner |
